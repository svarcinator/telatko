...
LTL formulas from literature and 366 random formulas.
%
...
\begin{table}[t]
  \caption{Considered LTL to automata translators and the numbers of
    fails and successfully constructed automata with at most one mark and with at least two marks for each translator and set of
    formulas.}
...
\begin{tabular}{lrrrrrrr}
  \toprule
  && \multicolumn{3}{c}{\!348 formulas from literature\!} & \multicolumn{3}{c}{366 random formulas}\\
  ...
  & 0 & 278 & \textbf{70} & ? & ? & \textbf{?}\\
  \texttt{ltl3tela} & (2.2.0)\tablefootnote{\url{https://github.com/jurajmajor/ltl3tela}}
  & 18 & 239 & \textbf{91} & ? & ? & \textbf{?}\\
  \texttt{ltl3tela -D1} & (2.2.0)\tablefootnote{\url{https://github.com/jurajmajor/ltl3tela}}
  & ? & ? & \textbf{?} & ? & ? & \textbf{?}\\ 
  \texttt{ltl2dela} & (21.0)\tablefootnote{\label{fn:owl}\url{https://owl.model.in.tum.de/}}
       & 5 & 214 & \textbf{129} & ? & ? & \textbf{?} \\
  \texttt{ltl2dgra} & (21.0)\footnotemark[4]
       & 12 & 102 & \textbf{234} & ? & ? & \textbf{?}\\
  \bottomrule
\end{tabular}
\end{table}
