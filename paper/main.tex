...
with the same structure, $n$ acceptance marks, an acceptance formula
in \todo{conjunctive?}  normal form with $k$ clauses, and the same set
...
automaton with the same structure, $n$ acceptance marks, and the same
