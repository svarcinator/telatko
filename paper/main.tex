...
marks as there is little point in reducing these. Table
...
multi-level reduction, always with an incremental approach and without
...
\begin{table}[h]
\caption{The cumulative number of acceptance marks before and after reduction
