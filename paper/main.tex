...
used translators. For each translator, it also provides the numbers of
fails, produced automata with less than two marks, and automata with
at least two marks that are actually used for the experimental
