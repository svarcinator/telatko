...
construction of the three mentioned QBF. The reduction algorithm
...
\section{Construction of formulas}\label{sec:qbf}
...
\begin{itemize}
\item a set $\oM$ of acceptance marks such that $|\oM|<|M|$,
...
\item a function
  ...
  some $\oM'\subseteq\oM$)
\item such that the automaton
$\mB=(Q,\oM,\Sigma,\rem(\delta),q_I,\psi)$ is equivalent to $\mA$.
\end{itemize}
...
reduction on individual automata of each automata sets. The chart
