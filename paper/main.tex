...
\begin{table}[t]
  \caption{The cummulative numbers of acceptance marks before and
    after reduction for various reductions and automata sets. The
    column \emph{reduction} shows the cummulative percentage of saved
    acceptance marks and \emph{time} reports the cummulative reduction
    time.
