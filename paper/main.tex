...
number of states can increase exponentially and some important
structural properties like determinism can be lost. This motivates our
study of a technique reducing the number of acceptance marks without
altering the structure of the automaton.

We present a technique heavily based on \emph{quantified Boolean
...
use $M(t)$ to refer to the set $M'$ of acceptance marks. Further, for
a set $T\subseteq\delta$ of transitions, $M(T)=\bigcup_{t\in T}M(t)$
denotes the set of acceptance marks that appear on transitions in $T$.
