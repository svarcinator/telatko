...
by \texttt{ltl3tela} with option \texttt{-D1} and by two
...
\fixme{Upravit zbytek textu a popis Table~3.}
...
\ref{fig:quantile-random}
\ref{fig:heatmap-random}
...
\begin{figure}[t]
  \caption{Quantile random.}
\label{fig:quantile-random}
\bigskip
\centering
