...
The reduction of acceptance marks is not the only purpose of the approach,
one could possibly look for e.g. equivalent parity automata or automata without
$\Fin$-marks, depending on the subsequent use of the automata.
Even though the QBF queries can be time-consuming, in practice it can be well
used and one can find a good trade-off between speed and efficiency by setting
