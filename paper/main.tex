...
affiliated to the same SCC an have the same sets of marks.
...
temporarily remove all transitions affilited to SCCs except one of
...
the construction of $\mcycle_3(\vec{e})$, we replace the subformula
