...
\todo{do sekce o implementaci napsat, ze namisto opakovaneho budovani
  $\Phi_{j,C,K}$ puzivame inkrementalni pristup.}
...
the satisfiability of QBF formulas. Moreover, in the experimental evaluation
we use several tools from the Spot library, i.e. \texttt{genltl},
\texttt{ltlfilt}, \texttt{ltl2tgba}, \texttt{autcross} and \texttt{autfilt},
to generate, simplify and translate LTL formulas and to compare and simplify
automata. \telatko is implemented in Python and has a CLI interface which allows users to specify details about a run. The tool expects file containing automata in HOA format ~\cite{babiak.15.cav} and processes the input file, the result is saved in the specified output file again in HOA format. If there is no output file given, \telatko prints the result to $\mathit{stdout}$. 
...
\texttt{ltl3tela} & 2.2.0  & \url{https://github.com/jurajmajor/ltl3tela} \todo{RELEASE} & 108\\
...
%\multicolumn{1}{c}{} & 3 & 4 & 5 & 6 & \multicolumn{1}{c}{7} \\
%%\specialrule{2pt}{0pt}{0pt}
%\cline{2-6}
%3 & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \cellcolor{blue!25}\makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} \\
%4 & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} \\
%5 & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} \\
%6 & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} \\
%7 & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} & \makecell{\tiny{12} \\ \tiny{34}} \\
%\cline{2-6}
%\end{tabular}
%\end{table}
...
Looking at Figure~\ref{fig:quantile}, we ascertain that for every set, the
reduction of most automata takes under a second.
